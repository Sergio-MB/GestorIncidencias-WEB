                ...
                <form action="logeo" method="post" >
                    <table id="formulario">
                        ...
                        <tbody>
                            ...
                            <tr >
                                <td align="left" id="registrarse"><a href="registrar_autonomo.html">Alta autonomo</a></td>
                                <td align="right" id="registrarse"><a href="registrar_user.html">Registrarse</a></td>
