...
function init() {
    document.getElementById("registraruser").addEventListener('click', validarUser, false);
...
function validarALL(objeto)
{
    ...
    if (!patron.test(document.getElementById("correo").value))
    {
        document.getElementById("correo").focus();
        document.getElementById("correo").className = "error1";
